...
Framed.Indicators.Bar = {}

-- ============================================================
-- OnUpdate handler for depleting animation
...
--- @return table bar
function Framed.Indicators.Bar.Create(parent, width, height, config)
    config = config or {}
    ...
    for k, v in pairs(BarMethods) do
        bar[k] = v
    end
