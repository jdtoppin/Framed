...
function F.SettingsCards.ShieldsAndAbsorbs(parent, width, unitType, getConfig, setConfig, onResize)
	...
	cardY = B.PlaceWidget(healPredMode, inner, cardY, B.SWITCH_H)
	...
	cardY = B.PlaceWidget(damageAbsorbCheck, inner, cardY, B.CHECK_H)
	...
	cardY = B.PlaceWidget(healAbsorbCheck, inner, cardY, B.CHECK_H)
	...
	cardY = B.PlaceWidget(overAbsorbCheck, inner, cardY, B.CHECK_H)
