...
-- ============================================================
-- FrameConfig — party pets live update.
-- Shared infrastructure lives in FrameConfigShared.lua.
-- Layout handlers live in FrameConfigLayout.lua.
-- Text handlers live in FrameConfigText.lua.
-- Preset switch handler lives in FrameConfigPreset.lua.
-- ============================================================
